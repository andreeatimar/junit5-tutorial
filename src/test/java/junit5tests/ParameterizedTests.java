...
public class ParameterizedTests {
    ...
    @ParameterizedTest
    @CsvSource(value = {"captain america,'steve,rogers", "winter soldier," + "'george,bush'"})
    void csvSource_StringWithComa(String param1, String param2) {
        System.out.println("param1 = " + param1 + ", param2 = " + param2);
    }

    @ParameterizedTest
    @CsvSource(value = {"steve?rogers", "maria?fritz"}, delimiter = '?')
    ...
    @ParameterizedTest
    @MethodSource(value = "sourceStreamAsString")
    void methodSource_StreamAsString(String param1) {
        System.out.println("param1 = " + param1);
    }
    ...
    Stream<String> sourceStreamAsString() {
        //processing
    ...
    List<Arguments> sourceList_StringDouble() {
        //processing
        return Arrays.asList(arguments("tomato", 2.0), arguments("carrot", 3.5),
